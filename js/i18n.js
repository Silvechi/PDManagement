...
const STRINGS = {
  en: {
    ...
    'meas.ccpd.bags_used':        'Bags used',
    'meas.ccpd.no_bags':          'No bags configured.',
    ...
    'hist.email_btn':         'Send report',
    'hist.email_title':       'Send Report',
    'hist.email_range':       'Period',
    'hist.email_recipients':  'Recipients',
    'hist.email_none':        'No recipients configured. Add them in the Recipients sheet.',
    'hist.email_select_all':  'Select all',
    'hist.email_send':        'Send',
    'hist.email_sending':     'Sending…',
  ...
  he: {
    ...
    'meas.ccpd.bags_used':        'שקיות בשימוש',
    'meas.ccpd.no_bags':          'לא הוגדרו שקיות.',
    ...
    'hist.email_recipients':  'נמענים',
    'hist.email_none':        'לא הוגדרו נמענים. הוסף אותם בלשונית Recipients בגיליון.',
    'hist.email_select_all':  'בחר הכל',
    'hist.email_send':        'שלח',
    'hist.email_sending':     'שולח…',
